...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10623&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chembl_structure_pipeline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chembl_structure_pipeline` can be installed with:

```
conda install chembl_structure_pipeline
```

It is possible to list all of the versions of `chembl_structure_pipeline` available on your platform with:
